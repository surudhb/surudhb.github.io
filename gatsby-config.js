...
module.exports = {
  ...
  siteMetadata: {
    ...
    dialogues: [
      "Hey! I am looking for new opportunities.",
      ...
      "The sound you hear when switching the theme is an easter egg!",
      "They're sounds of Star Wars Characters!",
      "Stay safe! Wear a mask! We will get through this :)",
      ".rap-god { word-spacing: 0; }",
      ".tower-of-pisa { font-style: italic; }",
      "I got a 167 on my LSAT",
      "Why was the Javascript developer sad?",
      "Because he didn't Node how to Express himself XD",
      "What's the OOP way of becoming wealthy? Inheritance.",
    ],
  },
  plugins: [
